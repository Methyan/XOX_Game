...
//----------------------------------------------------------------------------------------------------------------------
        ...
        for (i=0;i<5;i++){
            ...
            if (baslayan == 2){ // ilk olarak kullanıcı başlayacak
                matris_bos++;
                printf("\n\nKarakterinizi nereye yazacaksiniz: ");
                scanf("%d",&konum2);
                matris_doluluk[konum2] = 1;
                matris_yazidrma(konum2,karakter_secim);
                yazdirma();
                kontrol_sonuc = kontrol();
            ...
            // ---------------------------------------------------------------------------------------------------------------------
                ...
                /* --->-->-> konum belirleme fonksiyonunu yaz ve burada kullan
                ...
                matris_doluluk[konum1] = 1;
                matris_yazidrma(konum1,pc_karakter);
                yazdirma();
                kontrol_sonuc = kontrol();
                ...
                // !!! DİKKAT BU ALGORİTMA 5 DEFA DÖNÜYOR
            }

            else { // ilk olarak pc başlayacak
                printf("BURADA KOD YOK. PROGRAM KAPATILDI \n\n");
                return 0;
            }
...
int basit_yapay_zeka(){ // bilgisyar nereye harf koyacağına karar verdikten sonra oranın konumunu geriye döndürecek.
